...
function updateBtnAddVisibility() {
    ...
    // Hitung ulang baris aktual dari DOM agar selalu sinkron
...
function resetFormEskalasi() {
    ...
    // Reset counter baris & visibilitas tombol Add Item
    rowCount = 0;
...
function tambahBaris() {
    ...
    // Cek jika baris sudah 10 atau lebih, batasi langsung
    ...
    // Tombol hapus melayang (hollow), hanya tampil saat row disorot (group-hover), tidak muncul di baris pertama
    ...
    // Update visibilitas tombol Add Item tiap kali menambah baris
    updateBtnAddVisibility();
}
