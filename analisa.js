/**
 * Modul Analisa Data Spesifik Per Item & Kategori Project (Fixed Typo)
 */
    ...
    <div id="analisaModal" class="analisa-modal-backdrop hidden">
      <div class="analisa-modal-card">
        ...
        <div class="bg-[#f8f9fa] dark:bg-[#252525] px-4 sm:px-6 py-3.5 border-b border-[#f1f3f4] dark:border-[#3c4043] flex justify-between items-center shrink-0">
          ...
          <button onclick="closeAnalisaModal()" class="text-[#5f6368] dark:text-[#9aa0a6] hover:text-[#202124] dark:hover:text-white text-xl font-bold cursor-pointer">&times;</button>
        </div>
        ...
        <div class="p-4 sm:p-6 overflow-y-auto custom-scroll space-y-4 flex-1 text-xs">
          ...
          <div id="analisaContent" class="hidden space-y-4">
            ...
            <!-- TABEL TOP 5 BARANG PALING SERING KELUAR -->
            <div class="bg-[#f8f9fa] dark:bg-[#252525] p-3.5 rounded-xl border border-[#dadce0] dark:border-[#3c4043] space-y-2">
              <div class="flex justify-between items-center border-b border-[#dadce0] dark:border-[#3c4043] pb-2">
                <h4 class="font-bold text-[#202124] dark:text-[#e8eaed] flex items-center gap-1.5">
                  <span>🔥</span> Top 5 Barang Paling Sering Keluar (Fast Moving)
                </h4>
              ...
              <div class="overflow-x-auto">
                <table class="w-full text-left border-collapse text-[11px]">
                  ...
                  <tbody id="topItemsTableBody" class="divide-y divide-[#f1f3f4] dark:divide-[#3c4043] font-medium">
                    <tr>
                      <td colspan="4" class="py-2 text-center text-[#5f6368] dark:text-[#9aa0a6]">Memuat top 5 item...</td>
                    </tr>
                  </tbody>
                </table>
              </div>
        ...
        <!-- Footer Modal -->
        <div class="bg-[#f8f9fa] dark:bg-[#252525] px-4 sm:px-6 py-3 border-t border-[#f1f3f4] dark:border-[#3c4043] flex justify-end shrink-0">
          <button onclick="closeAnalisaModal()" class="px-4 py-2 bg-[#1a73e8] dark:bg-[#8ab4f8] text-white dark:text-[#202124] rounded-lg font-semibold text-xs transition cursor-pointer">
            Tutup
          </button>
        </div>
      </div>
...
async function runSpecificAnalysis() {
  ...
  try {
    ...
    // PERBAIKAN DI BARIS INI (lastOutTrx.out)
    ...
    renderTop5ItemsTable(itemOutAggregator);
...
function renderTop5ItemsTable(aggregator) {
