        ...
        globalHeaderWrapper.innerHTML = `
          <aside id="sidebar" 
            ...
            <div class="p-2 border-b border-slate-800 flex items-center gap-2.5 h-14">
              <!-- Avatar berfungsi sebagai tombol toggle -->
              <button type="button" 
              ...
              <div class="sidebar-text truncate">
                ...
                <p id="header-subtitle-text" class="text-[9px] text-slate-400 truncate">${autoSubtitle || 'System Integrated'}</p>
              </div>
            </div>

            <!-- Navigasi Menu Sidebar (Tanpa Frame Hover) -->
...
/* FUNGSI EXPAND / COLLAPSE OTOMATIS SAAT HOVER */
...
/* FUNGSI TOGGLE KLIK PADA AVATAR */
