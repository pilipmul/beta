 ...
 * Default: Sidebar Menyempit (Collapsed) & Auto-Sync Offset Margin
 */
function renderHeader({ subtitle } = {}) {
    ...
    if (globalHeaderWrapper) {
        // DEFAULT SIDEBAR: SET KE 'sidebar-collapsed'
        globalHeaderWrapper.innerHTML = `
          <aside id="sidebar" class="sidebar-collapsed min-h-screen flex flex-col fixed left-0 top-0 z-50">
            <!-- Header Sidebar & Button Toggle -->
            <div class="p-4 border-b border-slate-800 flex items-center justify-between h-16">
              ...
              <button type="button" onclick="toggleSidebar()" class="p-1.5 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-300 transition shrink-0 cursor-pointer border-0">
                <svg id="toggleIcon" class="w-5 h-5 transition-transform duration-300 rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 19l-7-7 7-7m8 14l-7-7 7-7" />
                </svg>
              </button>
            </div>

            <!-- Navigasi Menu Sidebar (Ikon Asli Dashboard.html) -->
            <nav class="flex-1 px-2 py-4 space-y-1 overflow-y-auto custom-scroll text-xs">
              
              <!-- Dashboard -->
              <a href="dashboard.html" class="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-slate-800 text-slate-300 hover:text-white transition no-underline" title="Dashboard">
              ...
              <!-- Eskalasi -->
              <a id="nav-eskalasi" href="eskalasi.html" class="hidden flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-slate-800 text-slate-300 hover:text-white transition no-underline" title="Eskalasi">
                <svg class="w-5 h-5 text-blue-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <!-- RKM -->
              <a id="nav-rkm" href="RKM.html" class="hidden flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-slate-800 text-slate-300 hover:text-white transition no-underline" title="RKM">
              ...
              <!-- Dok. Perbaikan -->
              <a id="nav-dokPerbaikan" href="sr.html" class="hidden flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-slate-800 text-slate-300 hover:text-white transition no-underline" title="Dok. Perbaikan">
              ...
              <!-- Tasks -->
              <a id="nav-tasks" href="tasks.html" class="hidden flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-slate-800 text-slate-300 hover:text-white transition no-underline" title="Tasks">
              ...
              <!-- Syncflow -->
              <a id="nav-syncflow" href="syncflow.html" class="hidden flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-slate-800 text-slate-300 hover:text-white transition no-underline" title="Syncflow">
                <svg class="w-5 h-5 text-blue-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <!-- Logistics -->
              <a id="nav-logistics" href="logistics.html" class="hidden flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-slate-800 text-slate-300 hover:text-white transition no-underline" title="Logistics">
                <svg class="w-5 h-5 text-emerald-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <!-- Inventory -->
              <a id="nav-inventory" href="inventory.html" class="hidden flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-slate-800 text-slate-300 hover:text-white transition no-underline" title="Inventory">
                <svg class="w-5 h-5 text-red-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <!-- Access Control -->
              <a id="nav-access" href="access.html" class="hidden flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-slate-800 text-slate-300 hover:text-white transition no-underline" title="Access Control">
                <svg class="w-5 h-5 text-amber-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <!-- Assets -->
              <a id="nav-assets" href="assets.html" class="hidden flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-slate-800 text-slate-300 hover:text-white transition no-underline" title="Assets">
            ...
            <!-- Footer Sidebar (Button Logout) -->
            <div class="p-3 border-t border-slate-800 text-xs">
              <button type="button" onclick="handleLogout()" class="w-full flex items-center gap-3 px-3 py-2 rounded-xl text-rose-400 hover:bg-slate-800 transition cursor-pointer border-0 bg-transparent" title="Keluar">
    ...
    // AUTO-SYNC OFFSET MAIN CONTENT AGAR TIDAK ADA SPACE KOSONG
