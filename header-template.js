          ...
          <aside id="sidebar" 
            ...
            <div class="p-2 border-b border-slate-800 flex items-center gap-2.5 h-14">
              ...
              <div class="sidebar-text truncate">
                <h1 class="text-[15px] font-bold leading-tight truncate">SOT</h1>
              </div>
            </div>
            ...
            <nav class="flex-1 px-1.5 py-3 space-y-2 overflow-y-auto custom-scroll text-xs">
              ...
              <!-- Map -->
              <a id="nav-map" href="map.html" class="hidden flex items-center gap-2.5 px-1 py-1.5 text-slate-400 hover:text-white transition no-underline" title="Map">
                ...
                <span class="sidebar-text truncate">Map</span>
              </a>
              ...
              <!-- Tenant -->
              <a id="nav-tenant" href="tenant.html" class="hidden flex items-center gap-2.5 px-1 py-1.5 text-slate-400 hover:text-white transition no-underline" title="Tenant">
                <svg class="w-5 h-5 text-teal-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5m0 0h5m-5 0V10m0 0V5m0 5h5m-5 0H7"/>
                </svg>
                <span class="sidebar-text truncate">Tenant</span>
              </a>

              <!-- HSE -->
              <a id="nav-hse" href="hse.html" class="hidden flex items-center gap-2.5 px-1 py-1.5 text-slate-400 hover:text-white transition no-underline" title="HSE">
                <svg class="w-5 h-5 text-emerald-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/>
                </svg>
                <span class="sidebar-text truncate">HSE</span>
              </a>
...
function initNavbarAccess() {
    ...
    modules.forEach(mod => {
        ...
        } else if (!allowed && mod.key === 'hse') {
            // Fallback hak akses HSE jika kolom hse belum terdefinisi secara spesifik pada user lama
