...
function switchFloor(floorKey) {
  ...
  ['basement', 'dasar', 'satu', 'dua', 'rooftop'].forEach(f => {
    ...
    if (tab) {
      if (f === floorKey) {
        tab.className = "w-full text-left px-3 py-1.5 font-semibold text-[#1a73e8] dark:text-[#8ab4f8] bg-blue-50 dark:bg-blue-900/30 transition cursor-pointer flex items-center justify-between";
      } else {
        tab.className = "w-full text-left px-3 py-1.5 font-medium text-[#202124] dark:text-[#e8eaed] transition hover:bg-[#f1f3f4] dark:hover:bg-[#3c4043] cursor-pointer flex items-center justify-between";
      }
    }
  });
...
function setActiveCategory(cat) {
  ...
  if (cat === 'tenant') {
    ...
    if (btnTenant) btnTenant.className = "w-full text-left px-3 py-1.5 font-semibold text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/30 transition cursor-pointer flex items-center gap-2";
    if (btnHse) btnHse.className = "w-full text-left px-3 py-1.5 font-medium text-[#202124] dark:text-[#e8eaed] transition hover:bg-[#f1f3f4] dark:hover:bg-[#3c4043] cursor-pointer flex items-center gap-2";
    ...
    if (btnHse) btnHse.className = "w-full text-left px-3 py-1.5 font-semibold text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-900/30 transition cursor-pointer flex items-center gap-2";
    if (btnTenant) btnTenant.className = "w-full text-left px-3 py-1.5 font-medium text-[#202124] dark:text-[#e8eaed] transition hover:bg-[#f1f3f4] dark:hover:bg-[#3c4043] cursor-pointer flex items-center gap-2";
